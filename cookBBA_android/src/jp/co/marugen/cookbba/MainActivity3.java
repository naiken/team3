...
public class MainActivity3 extends Activity {
    //たまねぎ画面
    private ImageView tamanegi;//たまねぎ
    ...
    private final int[] materialList = { R.drawable.cup, R.drawable.tamanegi01, R.drawable.tamanegi02, 
            R.drawable.tamanegi03, R.drawable.tamanegi04, R.drawable.tamanegi05 };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editor = pref.edit();
        //                initBringScore();
        tamanegi = (ImageView) findViewById(R.id.imageView1); 
        ...
        touchview.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (0 <= scorePoint && scorePoint <= 5) {
                    ...
                    tamanegi.setImageResource(R.drawable.tamanegi_great);
    ...
    public void countdown() {
        ...
        cdt = new CountDownTimer(5000,20) {
            ...
            public void onTick(long time) {
                ...
                if (scorePoint/5 == 0) {
                    tamanegi.setImageResource(materialList [5]);
                }
                else if (scorePoint/5 == 1) {
                    tamanegi.setImageResource(materialList [4]);
                }
                else if (scorePoint/5 == 2) {
                    tamanegi.setImageResource(materialList [3]);
                }
                else if (scorePoint/5 == 3) {
                    tamanegi.setImageResource(materialList [2]);
                }
                else if (scorePoint/5 == 4) {
                    tamanegi.setImageResource(materialList [1]);
                }
                else if (scorePoint/5 == 5) {
                    tamanegi.setImageResource(materialList [0]);
                }
