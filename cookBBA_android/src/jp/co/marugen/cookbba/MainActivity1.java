...
public class MainActivity1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        egg = (ImageView) findViewById(R.id.imageView1); 
        ...
        touchview.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(0<= scorePoint && scorePoint <= 5){
                    egg.setImageResource(R.drawable.egg03);
                ...
                else if (21<= scorePoint && scorePoint <=25) {
                    egg.setImageResource(R.drawable.egg02);
    ...
    public void countdown() {
        ...
        cdt = new CountDownTimer(5000,20) {
            ...
            public void onTick(long time) {
                ...
                if ( egg_anim ) {
                    scorePoint++;
                    egg.setTranslationY (egg.getTop()-100); //2.0ver実機エラー
                }
                else{
                    scorePoint--;
                    egg.setTranslationY (egg.getTop()+100);
                }
            }
